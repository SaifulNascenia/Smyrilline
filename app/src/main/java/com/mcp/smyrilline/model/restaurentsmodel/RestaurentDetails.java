...
public class RestaurentDetails implements Parcelable
{
    ...
    public final static Creator<RestaurentDetails> CREATOR = new Creator<RestaurentDetails>() {


        @SuppressWarnings({
            "unchecked"
        })
        public RestaurentDetails createFromParcel(Parcel in) {
            RestaurentDetails instance = new RestaurentDetails();
        ...
        public RestaurentDetails[] newArray(int size) {
            return (new RestaurentDetails[size]);
        }
