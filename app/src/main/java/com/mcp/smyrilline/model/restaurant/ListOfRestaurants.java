...
public class ListOfRestaurants implements Parcelable
{

    public final static Creator<ListOfRestaurants> CREATOR = new Creator<ListOfRestaurants>() {


        @SuppressWarnings({
                "unchecked"
        })
        public ListOfRestaurants createFromParcel(Parcel in) {
            ListOfRestaurants instance = new ListOfRestaurants();
        ...
        public ListOfRestaurants[] newArray(int size) {
            return (new ListOfRestaurants[size]);
        }
